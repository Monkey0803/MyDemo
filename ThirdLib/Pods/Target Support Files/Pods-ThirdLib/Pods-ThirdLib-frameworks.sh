...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GIKPopoverBackgroundView/GIKPopoverBackgroundView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MMSegmentSlider/MMSegmentSlider.framework"
